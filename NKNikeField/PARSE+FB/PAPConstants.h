...
#define kPAPAutoFollowAccountFacebookIds @[ @"673601489",@"829299885",@"505737572",@"501544848",@"593249438"]
...
#pragma mark - PFObject PlayerClass
// Class key
extern NSString *const kPAPPlayerClassKey;

// Field keys
extern NSString *const kPAPPlayerUserKey;
extern NSString *const kPAPPlayerPictureKey;
extern NSString *const kPAPPlayerThumbnailKey;
extern NSString *const kPAPPlayerHandleKey;
extern NSString *const kPAPPlayerFactionKey;
