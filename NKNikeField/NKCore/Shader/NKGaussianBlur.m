...
- (instancetype)initWithNode:(NKNode *)node blurSize:(float)blurRadiusInPixels numPasses:(NSUInteger)blurPasses {
    {
        ...
        //        //
        NSString *newGaussianBlurVertexShader = [[self class] vertexShaderForOptimizedBlurOfRadius:(NSUInteger)blurRadiusInPixels sigma:blurRadiusInPixels];
...
//        texFill->setOrientation(V3Make(0,0,180));
//    }
//    
//    [self.nodeRef.scene.camera end];
//    
//    fbo->begin();
//    
//    ofClear(0,0,0,255);
...
//    
//    [self.nodeRef.scene.camera begin];
//    
//    //    ofClear(0,0,0,255);
//    //    glPushMatrix();
//    //    ofTranslate(fbo->getWidth() / 2., fbo->getHeight()/2.);
...
//    fbo->end();
//    
//    int lastPassBuffer = 0;
//    ofSetColor(255,255,255,255);
//    
//    //****
//    // DO BLUR TO N PING/PONG BUFFERS
//    //****
//    
//    for (int i = 0; i < _blurPasses; i++) {
//        
//        float texelOff = (_blurRadiusInPixels / 4000.) * ((i/2)+1);
//
//        
//        if (!passBuffer[i%2]) {
...
//        }
//        passBuffer[i%2]->begin();
//        
//        ofClear(0, 0, 0,255);
//        
//        glPushMatrix();
//        ofTranslate(passBuffer[i%2]->getWidth() / 2., passBuffer[i%2]->getHeight()/2.);
//        
//        shader->begin();
//        
//        //NSLog(@"set ip tex");
//        
//        //texelOff = sin(CFAbsoluteTimeGetCurrent()) * .005 + .005;
//        if (i%2 == 0){
//            shader->setUniform1f("texelWidthOffset",  texelOff);
//            shader->setUniform1f("texelHeightOffset",  0);
//        }
//        else {
//            shader->setUniform1f("texelWidthOffset",  0);
//            shader->setUniform1f("texelHeightOffset",  texelOff);
//            //            shader->setUniform1f("texelWidthOffset",  texelOff);
//            //            shader->setUniform1f("texelHeightOffset",  0);
//        }
//        
...
//           // shader->setUniformTexture("tex0", self.nodeRef.depthFbo->getTextureReference(), 0);
//        }
//        else {
//            shader->setUniformTexture("tex0", passBuffer[(i-1)%2]->getTextureReference(), 0);
//        }
//        
//        if (self.needsDepthBuffer){
//            shader->setUniformTexture("depthTexture", self.nodeRef.depthFbo->getTextureReference(), 1);
//        }
//        
//        
//        if (self.paramBlock){
...
//        
//       
//        //ofDrawPlane(0, 0, pass2buffer->getWidth(), pass2buffer->getHeight());
//        //if (i == 0) {
//           // ofScale(.5, .5);
//        //}
//        
...
//    ofScale(2., 2.);
//    ofSetColor(255);
//    passBuffer[lastPassBuffer]->draw(-passBuffer[lastPassBuffer]->getWidth()*.5,-passBuffer[lastPassBuffer]->getHeight()*.5);
//    ofScale(.5, .5);
// //   ofEnableDepthTest();
//    
//    
////    glPopMatrix();
////    
////    ofMultMatrix(self.nodeRef.node->getGlobalTransformMatrix()); // RETURN TO WHERE WE WERE FOR ADDITIONAL CHILDREN
////
////    
//    
//    
...
//        {
//            [shaderString appendFormat:@"blurCoordinates[%ld] = texcoord - singleStepOffset * %f;\n", (unsigned long)currentBlurCoordinateIndex, (GLfloat)(-offsetFromCenter)];
//        }
