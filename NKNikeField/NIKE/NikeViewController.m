...
- (void)viewDidLoad{
    ...
    [_loginButton.titleLabel setFont:[UIFont fontWithName:@"TradeGothicLTStd-BdCn20" size:20]];
...
//    
//    [backButton.titleLabel setFont:[UIFont fontWithName:@"TradeGothicLTStd-BdCn20" size:20]];
